...
static void smash_walls(int x, int y, int direction, int **maze);
static void iterative_dfs(int x, int y, int xmax, int ymax, int **maze, int **visited);
static void recursive_dfs(int x, int y, int xmax, int ymax, int **maze, int **visited);
